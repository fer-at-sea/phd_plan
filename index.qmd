...
# Remote sensing of marine vegetation: monitoring approaches for coastal ecosystem management

::: {.text-center}
![](assets/img/logo_GEAM.png){width=80px}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;![](assets/img/logo_IEO.png){width=80px}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;![](assets/img/logo_CEAB.png){width=110px}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;![](assets/img/logo_CSIC.png){width=100px}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;![](assets/img/logo_UdG.png){width=100px}
:::
...
Jordi Boada (CEAB-CSIC) [![ORCID](https://orcid.org/sites/default/files/images/orcid_16x16.png)](https://orcid.org/0000-0002-3815-625X) [![](assets/img/img.png)](mailto:jboada@ceab.csic.es) ([CEAB-CSIC](https://www.ceab.csic.es/es/))  
Pablo González-González [![ORCID](https://orcid.org/sites/default/files/images/orcid_16x16.png)](https://orcid.org/0000-0002-9250-0920) [![](assets/img/img.png)](mailto:gonzalezgpablo@uniovi.es) ([AIC, Oviedo University ](https://www.aic.uniovi.es))  
...
The challenge of reconciling development and conservation must be urgently addressed at the global scale. In this context, the European Union has implemented an ambitious [Integrated Maritime Policy](https://research-and-innovation.ec.europa.eu/research-area/environment/oceans-and-seas/integrated-maritime-policy_en), based on two main pillars: (i) the Marine Strategy Framework Directive (MSFD, 2008/56/EC), aimed at managing anthropogenic activities and achieving Good Environmental Status, and (ii) the Maritime Spatial Planning Framework Directive (MSPFD, 2014/89/EU). Within this ecosystem-based approach, the EU has also adopted the [European Biodiversity Strategy](https://environment.ec.europa.eu/strategy/biodiversity-strategy-2030_en), aligned with the objectives of the Convention on Biological Diversity, which focus on improving biodiversity and ecosystem services, maintaining ecological integrity and connectivity, and strengthening genetic diversity. In addition, other European directives and international agreements—such as the Habitats Directive (92/43/EEC), the Barcelona Convention, and OSPAR—aim to protect coastal marine ecosystems through habitat conservation, biodiversity protection, and the reduction of anthropogenic pressures.

These conservation goals rely heavily on our ability to robustly monitor biodiversity at broad spatial and temporal scales to guide conservation efforts. While traditional marine ecology monitoring methods based on SCUBA diving provide accurate measures, they have important limitations in their spatial scale, thus failing to capture the relevant processes and impacts, which tend to happen at larger scales. In this context, new cost-effective tools that expand the scope of in-situ observations can be very relevant. Remote Sensing (RS) is already used to this end in terrestrial ecology but it is still not well implemented in the marine realm.

The main objective of this research project is to develop and test novel RS and geospatial methodologies for mapping and monitoring marine vegetated ecosystems in the intertidal and subtidal coastal zones. To achieve this, we will explore the potential of different RS platforms across two scales. First, underwater and aerial drones will be used to produce high-resolution maps, enabling the study of habitat spatial configuration, fragmentation and conservation status at fine scale. Second, satellite imagery will be employed to generate broad scale maps to asses habitat distribution, as well as to study temporal dynamics in habitat extent.


![Interaction of the different observing scales.](assets/img/scales.JPG){width=70%}
...
Optical RS for coastal habitat mapping and monitoring is a fast evolving field with many advancements in the recent years, both in the **intertidal** [@calleja_2017; @zoffoli_sentinel-2_2020; @zoffoli_decadal_2021; @zoffoli_remote_2022; @davies_multi_2023; @davies_sentinel_2024; @davies_intertidal_2024; @oiry_discriminating_2024; @davies_initial_2026] and **subtidal** zones [@fornes_mapping_2006; @brando_physics_2009; @traganos_mapping_2018; @poursanidis_use_2019; @traganos_spatially_2022]. I personally developed my Master's thesis [Remote Sensing Applications in marine protected areas:
using Sentinel-2 for satellite bathymetry estimation and benthic habitat mapping](https://dehesa.unex.es/entities/publication/a5f999ee-1419-41e2-ab14-e992a742bacd), which, in 2021, was a pioneer work using Sentinel-2 in the Balearic Archipelago.
...
<div class="text-center">
  ...
  <div><em>*3D model of a cuvette. France, 2022. More models available [here](https://sketchfab.com/fer-at-sea/models)*</em></div>
</div>
```
:::
...
### Main phd objective:
 Develop and test novel RS and geospatial methodologies for mapping and monitoring marine vegetated ecosystems in the **intertidal** and **subtidal** coastal zones.

### Specific objective 1: small scale
...
### Specific objective 2: small scale
...
This project will leverage a unique, long-term dataset of seagrass and marine vegetation observations collected over the past 20 years by the **Seagrass Ecology Group (IEO-CSIC)** and **CEAB-CSIC**. These in situ observations will serve to calibrate, validate, and interpret multi-temporal remote sensing products.
...
### 1. Training Courses
- Workshops on advanced remote sensing, geospatial data analysis, and deep learning applications will be attended to enhance technical skills.
- Training in coding, data management, FAIR data principles, and reproducible research practices.
...
- Potential congresses are:  
    ...
    - [FOSS4G (Free and Open Source Software for Geospatial)](https://2026.europe.foss4g.org)   
...
- Target publications during PhD:  
  ...
  - **Year 3:** At least 1 research paper on the use of Sentinel-2 to monitor underwater vegetation un marine protected areas.
